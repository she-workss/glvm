...
HWND WindowWinOpengl::GetClassicWindowHWND() {
    return pClassic_Window_;
}
HWND WindowWinOpengl::GetModernWindowHWND() {
    return pModern_Window_;
}

void WindowWinOpengl::CursorLock(int _x_position, int _y_position,
...
LRESULT CALLBACK WindowWinOpengl::MainWndProc(HWND _pHwnd, UINT _pMsg,
                                              WPARAM _pWParam,
                                              LPARAM _pLParam) {
