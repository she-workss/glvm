...
namespace GLVM::ecs
{
	CGUISystem::CGUISystem() {
		_Shader_Program = new Shader("shaders/gl_shaders/GUI.vert", "shaders/gl_shaders/GUI.frag");
		debugLines      = new Shader("shaders/gl_shaders/debugLines.vert", "shaders/gl_shaders/debugLines.frag");
	}
