...
void CCameraSystem::Update() {
    ...
    //     (pComponent_Manager->GetComponent<cm::transform>(uiEntity_refView));
    //     SetViewMatrix(*Player_Transform_Component,
    //     *pComponent_Manager->GetComponent<cm::beholder>(uiEntity_refView));
    // }
...
void CCameraSystem::SetViewMatrix(components::transform &_Player,
    ...
    //		std::cout << "x: " << _Player.tPosition[0] << " y: " <<
    //_Player.tPosition[1] << " z: " << _Player.tPosition[2] << std::endl;
    // std::cout << "Camera system" << std::endl;
    // std::cout << "x: " << cameraComponent.forward[0] << " y: " <<
    // cameraComponent.forward[1] << " z: " << cameraComponent.forward[2] <<
    // std::endl;
