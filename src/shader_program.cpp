...
void Shader::SetInt(const std::string &name, GLsizei count,
...
void Shader::SetVec4(const std::string &name, int x, int y, int z,
                     int w) const {
...
void Shader::SetMat4(const std::string &name, unsigned int matrixNumber,
                     mat4 &mat) const {
    pGLUniform_Matrix4fv(pGLGet_Uniform_Location(iID, name.c_str()),
