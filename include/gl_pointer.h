...
EXTERN void (*pGLVertex_Attrib_Pointer)(GLuint, GLint, GLenum, GLboolean,
...
EXTERN void (*pGLTex_Parameteri)(GLenum, GLenum, GLint);

EXTERN void (*pGLTex_Image2D)(GLenum, GLint, GLint, GLsizei, GLsizei, GLint,
...
EXTERN void (*pGLDelete_Buffers)(GLsizei, const GLuint *);

EXTERN GLuint (*pGLCreate_Shader)(GLenum);

EXTERN void (*pGLShader_Source)(GLuint, GLsizei, const GLchar **,
                                const GLint *);
...
EXTERN void (*pGLGet_Shaderiv)(GLuint, GLenum, GLint *);

EXTERN void (*pGLGet_Shader_Info_Log)(GLuint, GLsizei, GLsizei, GLchar *);

EXTERN void (*pGLGet_Programiv)(GLuint, GLenum, GLint *);

EXTERN void (*pGLGet_Program_Info_Log)(GLuint, GLsizei, GLsizei, GLchar *);

EXTERN void (*pGLUniform_Matrix4fv)(GLint, GLsizei, GLboolean, const GLfloat *);
...
EXTERN void (*pGLFramebuffer_Texture)(GLenum target, GLenum attachment,
                                      GLuint texture, GLint level);

EXTERN void (*pGLUniform1fv)(GLint location, GLsizei count,
                             const GLfloat *value);

EXTERN void (*pGLUniform3fv)(GLint location, GLsizei count,
                             const GLfloat *value);

EXTERN void (*pGLUniformMatrix4fv)(GLint location, GLsizei count,
