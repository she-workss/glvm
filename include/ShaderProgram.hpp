...
public:
    ...
    Shader(const char *vertexShaderPath_, const char *fragmentShaderPath_,
           const char *geometryShaderPath_ = nullptr) {
    ...
    void SetInt(const std::string &name, GLsizei count,
