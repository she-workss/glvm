#include "glvm/graphic_api/vk_debug_utils.hpp"
...
void setImageDebugObjectName(
    ...
    std::string imageName1 = std::string(VK_DEBUG_IMAGE_SET_RED) + " \x1b[31m" + imageName + " pipeline #\x1b[0m " + std::to_string(0);
...
void setPipelineDebugObjectName(
    ...
    std::string mainPipeLineImageName = std::string(VK_DEBUG_PIPELINE_RED) + " \x1b[31m" + pipelineName + " pipeline #\x1b[0m " + std::to_string(0);
...
void setDescriptorSetObjectName(
    ...
    descriptorSetObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string name = std::string(VK_DEBUG_DESCRIPTOR_SET_RED) + " \x1b[31m" + descriptorSetName + " descriptor set #\x1b[0m " + std::to_string(index);
...
void setDebugObjectNames(
    ...
    mainPipelineObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string mainPipeLineImageName = std::string(VK_DEBUG_PIPELINE_RED) + " \x1b[31mMain pipeline #\x1b[0m " + std::to_string(0);
    const char* mainPipeLineStrImageName = mainPipeLineImageName.c_str();
    mainPipelineObjectInfo.pObjectName = mainPipeLineStrImageName;
    mainPipelineObjectInfo.objectType = VK_OBJECT_TYPE_PIPELINE;
    ...
    mainPipelineLayoutObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string mainPipelineLayoutImageName = std::string(VK_DEBUG_PIPELINE_LAYOUT_RED) + " \x1b[31mMain pipeline layout #\x1b[0m " + std::to_string(0);
    ...
    directionalLightPipelineObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string directionalLightPipeLineImageName = std::string(VK_DEBUG_PIPELINE_RED) + " \x1b[31mDirectional light pipeline #\x1b[0m " + std::to_string(0);
    ...
    std::string directionalLightPipelineLayoutImageName =
        std::string(VK_DEBUG_PIPELINE_LAYOUT_RED) + " \x1b[31mDirectional light pipeline layout #\x1b[0m " + std::to_string(0);
    ...
    spotLightPipelineObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string spotLightPipeLineImageName = std::string(VK_DEBUG_PIPELINE_RED) + " \x1b[31mSpot light pipeline #\x1b[0m " + std::to_string(0);
    ...
    spotLightPipelineLayoutObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string spotLightPipelineLayoutImageName = std::string(VK_DEBUG_PIPELINE_LAYOUT_RED) + " \x1b[31mSpot light pipeline layout #\x1b[0m " + std::to_string(0);
    ...
    pointLightPipelineObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string pointLightPipeLineImageName = std::string(VK_DEBUG_PIPELINE_RED) + " \x1b[31mPoint light pipeline #\x1b[0m " + std::to_string(0);
    ...
    pointLightPipelineLayoutObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string pointLightPipelineLayoutImageName = std::string(VK_DEBUG_PIPELINE_LAYOUT_RED) + " \x1b[31mPoint light pipeline layout #\x1b[0m " + std::to_string(0);
    ...
    hudUniformBufferObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string hudImageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Hud uniform buffer # " + std::to_string(0);
    ...
    fontUniformBufferObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string fontImageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Font uniform buffer # " + std::to_string(0);
    ...
    uiUniformBufferObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string uiImageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " UI uniform buffer # " + std::to_string(0);
    ...
    uiIconsUniformBufferObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string uiIconsImageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " UI icons uniform buffer # " + std::to_string(0);
    ...
    directionalLightUniformBufferObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string directionalLightImageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Shadow map directional light model matrix uniform buffer # " + std::to_string(0);
    ...
    pointLightUniformBufferObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string pointLightImageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Shadow map point light model matrix uniform buffer # " + std::to_string(0);
    ...
    spotLightUniformBufferObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string spotLightImageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Shadow map spot light model matrix uniform buffer # " + std::to_string(0);
    ...
    for (unsigned long i = 0; i < vertexBufferContainer.size(); ++i) {
        ...
        uniformBufferObjectInfo.sType =
            VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
        std::string imageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Vertex uniform buffer # " + std::to_string(i);
    ...
    for (unsigned long i = 0; i < indexBufferContainer.size(); ++i) {
        ...
        uniformBufferObjectInfo.sType =
            VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
        std::string imageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Index uniform buffer # " + std::to_string(i);
        const char* strImageName = imageName.c_str();
        uniformBufferObjectInfo.pObjectName = strImageName;
        uniformBufferObjectInfo.objectType = VK_OBJECT_TYPE_BUFFER;
        uniformBufferObjectInfo.objectHandle =
    ...
    for (unsigned long i = 0; i < fontIndicesContainer.size(); ++i) {
        ...
        uniformBufferObjectInfo.sType =
            VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
        std::string imageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Font vertex uniform buffer # " + std::to_string(fontIndicesContainer[i]);
        const char* strImageName = imageName.c_str();
        uniformBufferObjectInfo.pObjectName = strImageName;
        uniformBufferObjectInfo.objectType = VK_OBJECT_TYPE_BUFFER;
        uniformBufferObjectInfo.objectHandle =
    ...
    for (unsigned long i = 0; i < fontIndicesContainer.size(); ++i) {
        ...
        uniformBufferObjectInfo.sType =
            VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
        std::string imageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Font index uniform buffer # " + std::to_string(fontIndicesContainer[i]);
        const char* strImageName = imageName.c_str();
        uniformBufferObjectInfo.pObjectName = strImageName;
        uniformBufferObjectInfo.objectType = VK_OBJECT_TYPE_BUFFER;
        uniformBufferObjectInfo.objectHandle =
    ...
    uniformBufferObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string imageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Model matrix uniform buffer # " + std::to_string(0);
    const char* strImageName = imageName.c_str();
    uniformBufferObjectInfo.pObjectName = strImageName;
    uniformBufferObjectInfo.objectType = VK_OBJECT_TYPE_BUFFER;
    uniformBufferObjectInfo.objectHandle =
    ...
    lightDataUniformBufferObjectInfo.sType =
        VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT;
    std::string lightDataImageName = std::string(VK_DEBUG_IMAGE_SET_RED) + " Light data uniform buffer # " + std::to_string(0);
