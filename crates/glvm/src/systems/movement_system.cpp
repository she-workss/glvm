...
void CMovementSystem::Update() {
    ...
    core::vector<Entity> linkedEntities =
        componentManager
            ->collectLinkedEntities<cm::controller, cm::beholder, cm::transform>();
    ...
    for (unsigned int n = 0;
        ...
        cm::transform* rTransform_Component =
            componentManager->GetComponent<cm::transform>(iEntity_refRigidBody);
        cm::rigidBody* rigidBodyComponennt =
            componentManager->GetComponent<cm::rigidBody>(iEntity_refRigidBody);
