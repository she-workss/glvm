...
#include "glvm/gl_pointer.h"
#include "glvm/i_system.hpp"
#include "glvm/stack.hpp"
#include "glvm/vertex_data.hpp"
...
public:
    ...
    void Update() override {
        ...
        std::vector<unsigned int>* pEntity_Container_refAnimationMove =
            ecs::GetEntityContainer<ecs::animation>(*pComponent_Manager);
        unsigned int uiVector_AnimationMove_Size =
            pEntity_Container_refAnimationMove->size();
