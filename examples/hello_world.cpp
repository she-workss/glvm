...
auto main() -> i32 {
    ...
    register_component<State>(ComponentsIndices::StateComponent);
    register_component<Enemy>(ComponentsIndices::EnemyComponent);
    register_component<Inventory>(ComponentsIndices::InventoryComponent);
    register_component<Item>(ComponentsIndices::ItemComponent);
    register_component<ProjectileBundle>(
        ComponentsIndices::ProjectileBundleComponent
    );
    register_component<CrosshairTagComponent>(
        ComponentsIndices::CrosshairTagComponent
    );
    register_component<LevelChunkTagComponent>(
        ComponentsIndices::LevelChunkTagComponent
    );
    register_component<PlayerTagComponent>(
        ComponentsIndices::PlayerTagComponent
    );
    register_component<ProjectileTagComponent>(
        ComponentsIndices::ProjectileTagComponent
    );
    register_component<StaticMeshTagComponent>(
        ComponentsIndices::StaticMeshTagComponent
    );
    // Game systems.
